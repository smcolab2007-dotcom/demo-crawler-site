...
seed = 'https://smcolab2007-dotcom.github.io/demo-crawler-site/'  # <-- GitHub Pages URL
...
while queue and len(seen) < MAX_LINKS:
    ...
    try:
        ...
        #results[url] = title <=== this is changed
        # Store data as dictionary for later SNA visualization
        results[url] = {
           "title": title,
           "links": list(links)
        }
